...
ax1.plot(t, oblate_lc-lc, label='oblate - circular')
# Update function
def update(val):
...
# Create sliders
s_theta = tk.Scale(root, label='Theta', from_=0.1, to=jnp.pi, orient=tk.HORIZONTAL, command=update,resolution=0.1)
s_impact = tk.Scale(root, label='Impact Param', from_=0.1, to=1.0, orient=tk.HORIZONTAL, command=update,resolution=0.1)
s_radius = tk.Scale(root, label='Radius', from_=0.1, to=1.0, orient=tk.HORIZONTAL, command=update, resolution=0.1)
s_f = tk.Scale(root, label='f', from_=0.1, to=1.0, orient=tk.HORIZONTAL, command=update, resolution=0.1)
